//BASE DE DATOS RESTAURANTE
	var productos = ["BOTELLÍN DE AGUA", "COCACOLA", "MOSOTO BLANCO", "FRANZISKANER", "VERDEJO", "CRIANZA", "ENSALADA", "ALUBIAS", "MACARRONES", "BACALAO AL PIL PIL", "SOLOMILLO", "CORDERO ASADO", "FLAN", "CUAJADAS", "TARTA DE MANZANA"];
	var imgGrandes = ["Imagenes/productos/botellaAgua.jpg", "Imagenes/productos/cocaCola.jpg", "Imagenes/productos/mostoBlanco.jpg", "Imagenes/productos/franziskaner.jpg", "Imagenes/productos/penalosaVerdejo.jpg", "Imagenes/productos/CarrizalCrianza.jpg", "Imagenes/productos/ensalada.png", "Imagenes/productos/alubias.jpg", "Imagenes/productos/macarrones.jpg", "Imagenes/productos/bacalao.jpg", "Imagenes/productos/solomillo.png", "Imagenes/productos/cordero.png", "Imagenes/productos/flan.png", "Imagenes/productos/cuajada.png", "Imagenes/productos/tartaManzana.png"];
	var imgPeque = ["Imagenes/productos/botellaAguam.jpg", "Imagenes/productos/cocaColam.jpg", "Imagenes/productos/mostoBlancom.jpg", "Imagenes/productos/franziskanerm.jpg", "Imagenes/productos/penalosaVerdejom.jpg", "Imagenes/productos/CarrizalCrianzam.jpg", "Imagenes/productos/ensaladam.png", "Imagenes/productos/alubiasm.jpg", "Imagenes/productos/macarronesm.jpg", "Imagenes/productos/bacalaom.jpg", "Imagenes/productos/solomillom.png", "Imagenes/productos/corderom.png", "Imagenes/productos/flanm.png", "Imagenes/productos/cuajadam.png", "Imagenes/productos/tartaManzanam.png"];
...
//BASE DE DATOS CAFETERIA
	var productos = ["BOTELLÍN DE AGUA", "KAS NARANJA", "COCACOLA", "COLACAO", "CAFE", "TE", "BARRA GRANDE", "CHAPATA", "BAGUETTE", "PAN DE PUEBLO", "PAN INTEGRAL", "PAN DE MOLDE", "CROISANT", "NAPOLITANA", "LACITOS"];
	var imgGrandes = ["Imagenes/productos/botellaAgua.jpg", "Imagenes/productos/kasNaranja.jpg", "Imagenes/productos/cocaCola.jpg", "Imagenes/productos/colacao.png", "Imagenes/productos/cafe.png", "Imagenes/productos/te.png", "Imagenes/productos/pan.jpg", "Imagenes/productos/chapata.png", "Imagenes/productos/baguette.jpg", "Imagenes/productos/panPueblo.jpg", "Imagenes/productos/panIntegral.jpg", "Imagenes/productos/panMolde.jpg", "Imagenes/productos/croisant.png", "Imagenes/productos/napolitana.jpg", "Imagenes/productos/lacitos.jpg"];
	var imgPeque = ["Imagenes/productos/botellaAguam.jpg", "Imagenes/productos/kasNaranjam.jpg", "Imagenes/productos/cocaColam.jpg", "Imagenes/productos/colacaom.png", "Imagenes/productos/cafem.png", "Imagenes/productos/tem.png", "Imagenes/productos/panm.jpg", "Imagenes/productos/chapatam.png", "Imagenes/productos/baguettem.jpg", "Imagenes/productos/panPueblom.jpg", "Imagenes/productos/panIntegralm.jpg", "Imagenes/productos/panMoldem.jpg", "Imagenes/productos/croisantm.png", "Imagenes/productos/napolitanam.jpg", "Imagenes/productos/lacitosm.jpg"];
	var precios = [1, 2.20, 2.20, 1.20, 1.50, 1.50, 3.90, 5.80, 5.80,1.5,1.5,1.5,2,2.50,5];
	var stock = [20, 15, 30, 15, 50, 45, 30, 20, 30,50,50,30,30,30,15];
	var precioTransporte = [6, 12, 20, "gratis"];
	var IVA = 0.21;
